...
AssemblyHandle assemblyHandle = NULL;
...
const char* (*GetPluginFullName)(PluginHandle) = NULL;
...
void* (*FindFunctionByName)(AssemblyHandle, _GoString_) = NULL;
...
JitCall (*NewCall)(void*, ManagedType*, ptrdiff_t, ManagedType);
void (*DeleteCall)(JitCall);
void* (*GetCallFunction)(JitCall);
const char* (*GetCallError)(JitCall);

// Function pointers for Callback functions
JitCallback (*NewCallback)(_GoString_, void*, void*);
void (*DeleteCallback)(JitCallback);
void* (*GetCallbackFunction)(JitCallback);
const char* (*GetCallbackError)(JitCallback);
...
// Function to call GetPluginFullName
const char* Plugify_GetPluginFullName() { return GetPluginFullName(pluginHandle); }
...
// Function to call FindPluginResource
const char* Plugify_FindPluginResource(_GoString_ path) { return FindPluginResource(pluginHandle, path); }
// Function to call FindFunctionByName
void* Plugify_FindFunctionByName(_GoString_ name) { return FindFunctionByName(assemblyHandle, name); }
...
void* Plugify_CallFunction(JitCall call, uintptr_t* params, __int128* ret) {
    ((void(*)(uintptr_t*, __int128*))GetCallFunction(call))(params, ret);
}

JitCallback Plugify_NewCallback(_GoString_ name, void* handler, void* delegate) { return NewCallback(name, handler, delegate); }
...
void Plugify_SetGetPluginFullName(void* ptr) { GetPluginFullName = (const char* (*)(PluginHandle)) ptr; }
...
void Plugify_SetFindFunctionByName(void* ptr) { FindFunctionByName = (void* (*)(AssemblyHandle, _GoString_)) ptr; }
...
void Plugify_SetNewCallback(void* ptr) { NewCallback = (JitCallback (*)(_GoString_, void*, void*)) ptr; }
